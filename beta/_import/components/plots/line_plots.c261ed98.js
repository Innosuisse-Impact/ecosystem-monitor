...
import { color_scale, color_range } from "../utils/colors.8262fe81.js"
...
{
  const pct = percent ? " %" : ""
const label = data[0].var_axis === undefined 
  ? (data[0].unit_name === undefined ? data[0].measure_name : data[0].measure_name + ", " + data[0].unit_name)
  : data[0].var_axis
