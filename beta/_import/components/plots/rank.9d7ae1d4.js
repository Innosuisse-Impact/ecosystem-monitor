...
export function plot_rank_bump(data, domain_fx, reverse = true, caption, document = undefined) {
    ...
    return Plot.plot({
        ...
        fx: { padding: 0.5, reverse: reverse, label: "", axis: "top", tickPadding: 25 },
        marks: [
            Plot.line(df, {
                x: "year_date",
                y: "rank",
